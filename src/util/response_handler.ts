...
export class ResponseHandler {
     ...
     */
    handle(res: Response, data: AppResponse) {
        if (data.success) {
     ...
     */
    successResponse(res: Response, data: AppResponse, statusCode = StatusCodes.OK) {
        let response: { data: any; meta?: any } = {
            data: data.data,
        };
        if (data.meta) {
     ...
     * @param statusCode number
     */
    errorResponse(res: Response, data: AppResponse, statusCode = StatusCodes.BAD_REQUEST) {
     ...
     * @param statusCode number
     */
    exceptionResponse(res: Response, data: AppResponse, statusCode = StatusCodes.INTERNAL_SERVER_ERROR) {
